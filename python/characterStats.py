...
os.environ["TREETAGGER_HOME"] = "/home/alexis/Documents/EPFL/MS3/Project/python/tree-tagger/cmd"
...
stopwords_pnouns = set(
	line.strip() for line in open(getScriptPath() + "/classifiersdata/stopwords_pnouns.txt", 'r') if line != '')
